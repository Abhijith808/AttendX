    ...
    <div class="card h-100">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-uppercase mb-1">Mailstep</div>
                ...
                <div class="col-auto">
                    <!-- Mailstep Button for Gmail -->
                    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=&su=Your%20Subject&body=Your%20Body" class="btn btn-primary">
